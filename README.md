...
# Eiffel Playground
This repository serves as a playground repository to test GitHub specific features not suitable to test with real repositories e.g. perform releases to trigger an automatic build engine, doing dummy pull requests to trigger automatic pipelines, etc.
